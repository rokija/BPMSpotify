...
describe('authActions', () => {
    ...
    //these two work if I request auth with axios request but then there is a CORS issue that's why I'm using spotify-sdk for it
    //which is not testable for these cases:
